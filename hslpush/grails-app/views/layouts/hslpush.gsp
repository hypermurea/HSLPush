...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		<g:if env="production">
  		_gaq.push(['_setAccount', '${grailsApplication.config.hslpush.google.analyticsId.production}']);
		</g:if>
		<g:else>
  		_gaq.push(['_setAccount', '${grailsApplication.config.hslpush.google.analyticsId.development}']);
		</g:else>
